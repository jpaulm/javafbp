...
Latest release is v4.1.1: the jar file - `javafbp-4.1.1.jar` - can be obtained from the Releases folder, from `build/libs` or from Maven Central - see shield below:
