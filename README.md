...
Latest release is `v4.1.4` although the highest version on Maven is `v4.1.3`.  The jar file - `javafbp-4.1.4.jar` - can be obtained from the Releases folder, from `build/libs`.
