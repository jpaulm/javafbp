...
Latest release is v4.1.1: the jar file - `javafbp-4.1.1.jar` - can be obtained from the Releases folder, or from `build/libs`.  It should be up on Maven shortly - see shield below:
