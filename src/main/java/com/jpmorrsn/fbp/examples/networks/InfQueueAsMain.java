...
public class InfQueueAsMain extends Network {
  ...
  protected void define() {
    ...
    initialize("resources/testdata/temp".replace("/", File.separator), component("Write"), port("DESTINATION"));
    initialize("resources/testdata/temp".replace("/", File.separator), component("Read"), port("SOURCE"));
