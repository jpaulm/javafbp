...
public abstract class SubNet extends Network {
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.Network#signalError(com.jpmorrsn.fbp.core.engine.Component, java.lang.Exception)
   */
  @Override
  ...
  protected/* (non-Javadoc)
           * @see com.jpmorrsn.fbp.core.engine.Network#terminate(com.jpmorrsn.fbp.core.engine.Component.StatusValues)
           */
