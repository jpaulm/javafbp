...
public class ConnArray implements InputPort {
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#capacity()
   */
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#close()
   */
  public void close() {
    //
  }
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#count()
   */
  // private int count() {    
  //   return 0;
  //}
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#getName()
   */
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#getReceiver()
   */
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#receive()
   */
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#setReceiver(com.jpmorrsn.fbp.core.engine.Component)
   */
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#setType(java.lang.Class)
   */
  @SuppressWarnings("unused")
  ...
  /* (non-Javadoc)
   * @see com.jpmorrsn.fbp.core.engine.InputPort#isClosed()
   */
