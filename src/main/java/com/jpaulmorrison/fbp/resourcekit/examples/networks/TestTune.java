...
import com.jpaulmorrison.fbp.core.components.audio.Text2IntArray;
...
public class TestTune extends Network {
  ...
  protected void define() {
    component("_Read_Tune_File", com.jpaulmorrison.fbp.core.components.io.ReadFile.class);
    component("_Text_to_Int_Array", Text2IntArray.class);
    //component("_Play_Tune", com.jpaulmorrison.fbp.core.components.PlayTune.class);
    //component("Display", com.jpaulmorrison.fbp.core.components.misc.WriteToConsole.class);
    component("GenSamples", com.jpaulmorrison.fbp.core.components.audio.GenSamples.class);
