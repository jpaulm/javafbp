...
import com.jpaulmorrison.fbp.resourcekit.experimental.components.TabulaRasa;
...
public class CopyTR extends Network {
  ...
  protected void define() {
    ...
    initialize("com.jpaulmorrison.fbp.core.components.Copy", component("TabulaRasa"), port("COMP"));
