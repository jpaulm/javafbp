...
public class TestBalloon extends Network {
  ...
  protected void define() {
    ...
    connect(component("Gene\\ra\"te", GenerateTestData.class), port("OUT"),
        component("Balloon", com.jpaulmorrison.fbp.resourcekit.experimental.components.Balloon.class), port("IN"));

    connect(component("Balloon"), port("OUT"),
        component("Check", com.jpaulmorrison.fbp.resourcekit.examples.components.CheckBallooning.class), port("IN"), 1);
